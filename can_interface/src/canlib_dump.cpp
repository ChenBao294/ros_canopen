...
#include <can_interface/canlib_driver.h>
...
boost::shared_ptr<CanlibDriverInterface> g_driver;
...
int main(int argc, char *argv[]){
    ...
    if(argc == 4 ){
        try
        {
            ...
            g_driver = g_loader->createInstance<CanlibDriverInterface>(argv[3]);
        }
        ...
        g_driver = boost::make_shared<CanlibInterface>();
    }
    ...
    if(!g_driver->init(argv[1], argv[2], false)){
